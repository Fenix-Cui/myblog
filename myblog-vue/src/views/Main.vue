    ...
    <div class="header">
      <div style="width: 100%">
        <el-menu class="el-menu-demo" mode="horizontal" router>
          <el-menu-item><a href="http://fenix-cui.xyz"><el-image src="static/images/bunny.ico"></el-image></a></el-menu-item>
          <el-menu-item index="1">主页</el-menu-item>
          <el-submenu index="2">
            <template slot="title">工作台</template>
            <el-menu-item index="2-1">( •̀ ω •́ )✧</el-menu-item>
            <el-submenu index="2-4">
              <template slot="title">👉</template>
              <el-menu-item index="2-4-1">~(￣▽￣)~*</el-menu-item>meixi
            </el-submenu>
          </el-submenu>
...
<script>
  ...
  export default {
    ...
    mounted() {
      axios.get("/api/http/main/getMainTitle").then((res)=>{
